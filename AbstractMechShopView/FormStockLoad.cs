...
{
    public partial class FormStockLoad : Form
    {
        [Dependency]
        public new IUnityContainer Container { get; set; }
        private readonly IReportService service;
        public FormStockLoad(IReportService service)
        {
            InitializeComponent();
            this.service = service;
        }

        private void FormStockLoad_Load(object sender, EventArgs e)
        {
            try
            {
...
listElem.Item2 });
        ...
        private void SaveBtnExcel_Click(object sender, EventArgs e)
        {
